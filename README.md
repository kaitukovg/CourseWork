...
### Поток данных
```
Пользователь → События → Объекты → Обновление → База переменных
    ↑                                         ↓
Интерфейс ← Рендеринг ← Состояние ← Подписки ←
```

### Ключевые паттерны проектирования
- **Observer** - Подписка на изменения переменных
- **Factory** - Создание сложных объектов сцен
- **Strategy** - Единый интерфейс для визуальных объектов
